% EXPERIMENT CORRESPONDS to Mauricio proposal: 
% RESUNET in combine with a dense RMS-UNET prersented by Rayyan
% done on the 18th april
...
if doTraining 
    ...
    net_P_ResnetMau2=net;
    save net_P_ResnetMau2 net_P_ResnetMau2;
    info_net_P_ResnetMau2=info;
    save info_net_P_ResnetMau2 info_net_P_ResnetMau2
